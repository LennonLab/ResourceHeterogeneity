...
## Supplemental Table 1: Lake Properties
```{r, results="asis"}
addtorow <- list()
addtorow$pos <- list(0)
addtorow$command <- c("Lake & Depth (m) & Area (Km$^2$) \\\\\n")
...
arrows(10, 100, x1 = -10, y1 = 100, length=0.05, col = "red", lwd = 2)
text(-36, 100, "Ann", col="red", cex=1.2)
arrows(60, 230, x1 = 40, y1 = 230, length=0.05, col = "red", lwd = 2)
text(8, 230, "Pony", col="red", cex=1.2)
arrows(55, -230, x1 = 75, y1 = -230, length=0.05, col = "red", lwd = 2)
text(120, -230, "Canyon", col="red", cex=1.2)

# Right Side
PlotOnStaticMap(newmap2, zoom = 13, cex = 2, col = "blue")
text(-180, -90, "Ives", col="red", cex=1.2)
arrows(-160, 20, x1 = -140, y1 = 20, length = 0.05, col = "red", lwd = 2)
text(-75, 20, "Upper Pine", col="red", cex = 1.2)
arrows(-220, 80, x1 = -200, y1 = 80, length = 0.05, col = "red", lwd = 2)
text(-125, 80, "Second Pine", col="red", cex = 1.2)
arrows(-55, -105, x1 = -35, y1 = -105, length = 0.05, col = "red", lwd = 2)
text(-12, -105, "Lily", col="red", cex=1.2)

# Compass Arrow
arrows(280, 280, 280, 240, length = 0.1, col = "black", lwd = 3)
...
Additionally, bacterial respiration differs between lakes though there is also temperature dependence with these values as well.
...
ordiellipse(cbind(hmwf.pcoa$points[ ,1], hmwf.pcoa$points[ ,2]),
    ...
    lwd=2, draw = "polygon", col="gray", border = "black", label=FALSE, 
    cex=1, bty = 'n')
