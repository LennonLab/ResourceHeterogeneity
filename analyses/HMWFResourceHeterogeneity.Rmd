...
evenmod <- glm(res.div$res.simpsE ~ nuts2012$DOC+nuts2012$TN+nuts2012$TP)
...
hmwf.uni.R.rda <- capscale(Uni.REL.R ~ env.chem$DOC + env.chem$TP + env.chem$TN, 
                            comm = OTUsREL.R, add = T)
hmwf.res.rda <- capscale(Bray.OM ~ env.chem2012$DOC + 
                         env.chem2012$TP + env.chem2012$TN,
                         comm = resREL, add = T)
