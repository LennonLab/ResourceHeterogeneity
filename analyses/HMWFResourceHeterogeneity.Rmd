...
```{r, results= 'hide'}
png(filename="../figures/Figure7A.png",
    width = 1200, height = 1000, res = 96*2)
par(opar)
...
img <- readPNG("../figures/Figure7A.png")
grid.raster(img)
```
...
# Do environmental differences explain bacterial respiration rates
```{r}

```

## Phosphorus Contributes to Respiration Rate
```{r, results= 'hide'}
png(filename="../figures/Figure7.png",
    width = 1800, height = 1000, res = 96*2)
par(opar)
