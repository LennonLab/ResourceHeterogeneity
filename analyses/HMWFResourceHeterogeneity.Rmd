...
```{r, results = "hide"}
# pairs(cbind(log10(nuts$DOC), log10(nuts$TN), log10(nuts$TP)), 
#       labels = c("DOC", "TN", "TP"), pch = 21, bg = "gray",
#       lwd = 2, cex.axis = 1, las = 1)
# 
# par(mfrow= c(3, 3), mar = c(0.5, 0.5, 0.5, 0.5), oma = c(3, 3, 1, 1))
# plot(1, 1, axes = F, type = "n")
# text(1, 1, "DOC", cex = 3)
# text(1, 0.75, "mg C/L", cex = 1.5)

# plot(y = log10(nuts$DOC), x = log10(nuts$TN), pch = 21, bg = "gray", axes=F)
# box(lwd = 1)
# plot(y = log10(nuts$DOC), x = log10(nuts$TP), pch = 21, bg = "gray", axes=F)
# box(lwd = 1)
# plot(y = log10(nuts$TN), x = log10(nuts$DOC), pch = 21, bg = "gray", axes=F)
# box(lwd = 1)
# plot(1, 1, axes = F, type = "n")
# text(1, 1, "TN", cex = 3)
# text(1, 0.75, "mg N/L", cex = 1.5)
# plot(y = log10(nuts$TN), x = log10(nuts$TP), pch = 21, bg = "gray", axes=F)
# box(lwd = 1)
# plot(y = log10(nuts$TP), x = log10(nuts$DOC), pch = 21, bg = "gray", axes=F)
# box(lwd = 1)
# plot(y = log10(nuts$TP), x = log10(nuts$TN), pch = 21, bg = "gray", axes=F)
# box(lwd = 1)
# plot(1, 1, axes = F, type = "n")
# text(1, 1, "TP", cex = 3)
# text(1, 0.75, expression(paste(mu, "g P/L")), cex = 1.5)
