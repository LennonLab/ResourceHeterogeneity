...
png(filename="../figures/Figure3.png",
    width = 1200, height = 900, res = 96*2, bg = "white")

# Define Plot Parameters
par(opar)
par(mar = c(5, 6, 1, 1) + 0.5)
...
plot(pcoa.BAC$points[ ,1], pcoa.BAC$points[ ,2], 
     ...
     pch = 22, cex = 2.0, type = "n", cex.lab = 2, cex.axis = 1, 
     axes = FALSE)

# Add Axes
axis(side = 1, labels = T, lwd.ticks = 2, cex.axis = 1.5, las = 1)
axis(side = 2, labels = T, lwd.ticks = 2, cex.axis = 1.5, las = 1, 
     at = c(-0.2, 0, 0.2, 0.4))
axis(side = 3, labels = F, lwd.ticks = 2, cex.axis = 1, las = 1, tck=-0.02)
axis(side = 4, labels = F, lwd.ticks = 2, cex.axis = 1, las = 1, tck=-0.02, 
     at = c(-0.2, 0, 0.2, 0.4))
...
mtext(side = 1, paste("PCoA 1 (", explainvar1, "%)", sep = ""), 
      cex = 2, line = 3.5)
mtext(side = 2, paste("PCoA 2 (", explainvar2, "%)", sep = ""), 
      cex = 2, line = 4)
