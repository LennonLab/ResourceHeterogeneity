...
plot(res.div$res.shan,  row.names(res.div), las = 1, cex=1.5,
...
plot(res.div$DOC ~ res.div$res.simpsE)
...
# Initiate Plot
plot(res.pcoa$points[ ,1], res.pcoa$points[ ,2], ylim = c(-0.1, 0.15),
     xlim = c(-0.2, 0.15), 
     xlab = paste("PCoA 1 (", explainvar1, "%)", sep = ""),
     ylab = paste("PCoA 2 (", explainvar2, "%)", sep = ""),
     pch = 16, cex = 2.0, type = "n", cex.lab = 1.5, cex.axis = 1.2, axes = FALSE)
