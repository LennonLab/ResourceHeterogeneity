...
mtext("Specialist", side = 2, line = -5, cex = 1, adj = 1, las = 1, at = -0.26, xpd = T)
arrows(x0 = 0.31, y0 = 1.075, x1 = 0.83, y1 = 1.075, length = 0.1, angle = 45, lwd = 3, xpd = T)
...
# Positive Network
graph.list <- graph.list.full[graph.list.full$int > 0.8, ]
...
plot(hmwf.network, layout=layout.fruchterman.reingold, 
     main='Feedback Networks', vertex.label.dist=0,
     vertex.label.color='black', vertex.label.cex=0.5,
     edge.width = 4)
